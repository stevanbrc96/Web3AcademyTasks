...
contract DAO {
    ...
    // IZMENJEN KONSTRUKTOR: Dodat _daoCreator
    constructor(string memory _baseTokenURI, address _daoCreator) payable {  
        membershipNFT = new MembershipNFT(_baseTokenURI, _daoCreator); 
    ...
    function getProposal(uint256 _proposalId) // Dobijanje detalja predloga
        external
        view
        returns (
            address proposalCreator,
